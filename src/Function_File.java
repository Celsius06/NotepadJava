...
public class Function_File {
	...
	public void open() {
	    ...
	    System.out.println("Opened chosen file with file address and file name: " + fileAddress + fileName);	// Print out the file directory and file name in the terminal
	        try {
	            BufferedReader br = new BufferedReader(new FileReader(fileAddress + fileName)); 	// Link directory and file name to open the text
	            gui.textArea.setText("");
	            String line = null;
